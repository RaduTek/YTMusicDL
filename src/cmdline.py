...
def parse_args():
    ...
    parser.add_argument('-f', '--format', type=str.lower, choices=config.formats_ext,
    ...
    parser.add_argument('--cover-format', type=str.lower, choices=config.cover_formats,
    ...
    parser.add_argument('--no-lyrics', action='store_true', 
                        help="Don't obtain lyrics")
    parser.add_argument('--skip-existing', action='store_true', 
                        help="Skip over existing files")
    ...
    parser.add_argument('--skip-already-archive-message', action='store_true',
    ...
    parser.add_argument('--log', type=str, 
                        help="Path to verbose log output file")
    parser.add_argument('--log-verbose', action='store_true', 
                        help="Save all debug messages to the log")
